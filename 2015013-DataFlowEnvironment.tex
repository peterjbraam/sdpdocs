...
\begin{Example}[A dataflow program with explicit scheduling step]
...
The \underline{channels} will be implemented in the {\bf C.3.1 Data
  Manager}, building on top of the {\bf C.2.2} Middleware . The
channels will be capable of buffering multiple tokens.  The tokens
will be implemented by the DataObject concept in the {\bf C.3 Data
  Layer}.
